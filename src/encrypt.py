...
🔒 Secure AES-256-GCM encryption with beautiful UI
"""
...
class ModernEncryptApp:
    ...
    def create_file_section(self):
        file_frame = ctk.CTkFrame(self.left_panel, corner_radius=12)
        ...
        drop_frame.pack(fill="x", padx=20, pady=(0, 15))
        ...
        ctk.CTkLabel(list_frame, text="Selected Files:").pack(anchor="w")
        ...
        self.file_listbox.pack(fill="both", pady=(5, 0))
        
    def create_options_section(self):
        options_frame = ctk.CTkFrame(self.left_panel, corner_radius=12)
        ...
        ctk.CTkLabel(password_frame, text="Encryption Password:").pack(anchor="w")
        
        pass_input_frame = ctk.CTkFrame(password_frame, fg_color="transparent")
        pass_input_frame.pack(fill="x", pady=(8, 0))
        ...
        options_grid.pack(fill="x", padx=20, pady=15)
    ...
    def create_actions_section(self):
        actions_frame = ctk.CTkFrame(self.left_panel, corner_radius=12)
        ...
        self.encrypt_btn.pack(fill="x", pady=(0, 10))
    ...
    def on_drop(self, event):
        ...
        self.log(f"📥 Added {len(files)} file(s) via drag & drop")
        self.update_status(f"📁 {len(files)} files added")
    ...
    def show_success_dialog(self, output_file, key_file):
        ...
        warning_label.pack(anchor="w", padx=20, pady=15)
