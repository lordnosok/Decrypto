...
🔓 Secure decryption for .decry containers with adaptive UI
"""
...
class ModernDecryptApp:
    ...
    def create_input_section(self):
        # Container selection
        container_frame = ctk.CTkFrame(self.left_panel, corner_radius=10)
        ...
        container_entry.pack(fill="x", padx=15, pady=(0, 8))
        ...
        # Key input
        key_frame = ctk.CTkFrame(self.left_panel, corner_radius=10)
        ...
        ctk.CTkLabel(key_frame, text="Password or Key File:", font=ctk.CTkFont(size=11)).pack(anchor="w", padx=15, pady=(0, 3))
        ...
        self.key_entry.pack(fill="x", padx=15, pady=(0, 8))
        
        key_button_frame = ctk.CTkFrame(key_frame, fg_color="transparent")
        key_button_frame.pack(fill="x", padx=15, pady=(0, 12))
        ...
        # Output location
        output_frame = ctk.CTkFrame(self.left_panel, corner_radius=10)
        ...
        output_entry.pack(fill="x", padx=15, pady=(0, 8))
        ...
        # Action buttons
        action_frame = ctk.CTkFrame(self.left_panel, corner_radius=10)
        ...
        self.decrypt_btn.pack(fill="x", pady=(0, 8))
    ...
    def create_preview_section(self):
        preview_frame = ctk.CTkFrame(self.right_panel, corner_radius=10)
    ...
    def create_log_section(self):
        ...
        # Status bar
        self.status_var = ctk.StringVar(value="🟢 Ready for decryption")
    ...
    def browse_output(self):
        ...
        if output_dir:
            ...
            self.log(f"📂 Output directory: {Path(output_dir).name}")
    ...
    def decrypt_files(self):
        ...
        try:
            ...
            with open(container_path, 'rb') as f:
                ...
                self.preview_text.insert("end", "═" * 40 + "\n\n")
                self.preview_text.insert("end", f"• Created: {metadata['created'][:19]}\n")
                ...
                self.preview_text.insert("end", "─" * 25 + "\n")
